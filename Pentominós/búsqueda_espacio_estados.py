...
#                   for x in self.nodos)
    ...
    def __contains__(self, nodo):
        return any(numpy.array_equal(x[2].estado[0],nodo.estado[0]) and x[2].estado[1] == nodo.estado[1] and 
                   x[2].estado[2] == nodo.estado[2] and x[2].heurística <= nodo.heurística for x in self.nodos)
...
#            self.explorados)
            ...
            lambda self, nodo: any( numpy.array_equal(x.estado[0],nodo.estado[0]) and x.estado[1] == nodo.estado[1] 
                                   and x.estado[2] == nodo.estado[2] and x.heurística <= nodo.heurística for x in self), 
            self.explorados)
